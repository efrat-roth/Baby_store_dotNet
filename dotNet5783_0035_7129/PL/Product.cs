...
namespace ProductDataBiding
{
    ...
    public class OrderItem : DependencyObject
    {
        ...
        /// The id of the product.
        /// </summary>
        public int IDProduct { get => (int)GetValue(IDProductProperty); set => SetValue(IDProductProperty, value); }

        public static readonly DependencyProperty IDProductProperty =
            DependencyProperty.Register(nameof(IDProduct), typeof(int), typeof(Product));/// <summary>
        ///
        /// The name of the product.
        /// </summary>
        public static readonly DependencyProperty NameProperty =
